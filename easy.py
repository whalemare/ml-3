...
if __name__ == "__main__":
    ...
    # defining an ANN with 1 input layer (size 784 = size of the image flattened), 1 hidden
    # layer (size 32), and 1 output layer (size 10, unit at index i will predict the probability of the image being
    # digit i, where 0 <= i <= 9)
    NN = NeuralNet([784, 32, 10])
